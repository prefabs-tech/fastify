...
**Read order:** [AGENTS.md](./AGENTS.md) → [docs/llm/INDEX.md](./docs/llm/INDEX.md) → [docs/llm/EXAMPLES.md](./docs/llm/EXAMPLES.md). Deep links to source and tests: [REFERENCE (swagger)](https://github.com/prefabs-tech/fastify/blob/main/docs/llm/REFERENCE.md#swagger). Avoid scanning `dist/` or large trees unless those docs are stale or insufficient.
