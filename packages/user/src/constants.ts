...
const ERROR_CODES = {
  ADD_ROLE_FAILED: "ADD_ROLE_FAILED_ERROR",
  CHANGE_EMAIL: "CHANGE_EMAIL_ERROR",
  CHANGE_PASSWORD: "CHANGE_PASSWORD_ERROR",
  EMAIL_VERIFICATION_TOKEN_FAILED: "EMAIL_VERIFICATION_TOKEN_FAILED_ERROR",
  ...
  RESET_PASSWORD_TOKEN_FAILED: "RESET_PASSWORD_TOKEN_FAILED_ERROR",
