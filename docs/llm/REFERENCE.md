...
- **Cross-package routing** → [docs/llm/INDEX.md](./INDEX.md) (**Common intents**).
- **Task → smallest file first** → open `packages/<name>/docs/llm/EXAMPLES.md` in the repo for that package (same `<name>` as the INDEX you chose); each package section below also links this as **LLM**.
- **Runnable demos** → the **usage / “demo”** line under the package heading, after opening **LLM** / **EXAMPLES** when you need a guided path.
- **Change behavior** → `src/plugin.ts`, then the tests linked in that package section.
...
- **LLM:** [packages/config/docs/llm/INDEX.md](../../packages/config/docs/llm/INDEX.md) · [packages/config/docs/llm/EXAMPLES.md](../../packages/config/docs/llm/EXAMPLES.md)
...
- **LLM:** [packages/error-handler/docs/llm/INDEX.md](../../packages/error-handler/docs/llm/INDEX.md) · [packages/error-handler/docs/llm/EXAMPLES.md](../../packages/error-handler/docs/llm/EXAMPLES.md)
...
- **LLM:** [packages/swagger/docs/llm/INDEX.md](../../packages/swagger/docs/llm/INDEX.md) · [packages/swagger/docs/llm/EXAMPLES.md](../../packages/swagger/docs/llm/EXAMPLES.md)
...
- **LLM:** [packages/slonik/docs/llm/INDEX.md](../../packages/slonik/docs/llm/INDEX.md) · [packages/slonik/docs/llm/EXAMPLES.md](../../packages/slonik/docs/llm/EXAMPLES.md)
...
- **LLM:** [packages/graphql/docs/llm/INDEX.md](../../packages/graphql/docs/llm/INDEX.md) · [packages/graphql/docs/llm/EXAMPLES.md](../../packages/graphql/docs/llm/EXAMPLES.md)
...
- **LLM:** [packages/s3/docs/llm/INDEX.md](../../packages/s3/docs/llm/INDEX.md) · [packages/s3/docs/llm/EXAMPLES.md](../../packages/s3/docs/llm/EXAMPLES.md)
...
- **LLM:** [packages/mailer/docs/llm/INDEX.md](../../packages/mailer/docs/llm/INDEX.md) · [packages/mailer/docs/llm/EXAMPLES.md](../../packages/mailer/docs/llm/EXAMPLES.md)
...
- **LLM:** [packages/firebase/docs/llm/INDEX.md](../../packages/firebase/docs/llm/INDEX.md) · [packages/firebase/docs/llm/EXAMPLES.md](../../packages/firebase/docs/llm/EXAMPLES.md)
...
- **docs:** [packages/user/GUIDE.md](../../packages/user/GUIDE.md) · [packages/user/README.md](../../packages/user/README.md) · [packages/user/FEATURES.md](../../packages/user/FEATURES.md)
- **LLM:** [packages/user/docs/llm/INDEX.md](../../packages/user/docs/llm/INDEX.md) · [packages/user/docs/llm/EXAMPLES.md](../../packages/user/docs/llm/EXAMPLES.md)
...
- **Last verified:** `3641660c83c68a1dd60fb69e95fc157a697bdb47` — docs layout and links were checked against this commit; after meaningful public API, config, or route behavior changes, update [CHANGES.md](./CHANGES.md) if needed and set this SHA to the commit where layout and links were verified.
