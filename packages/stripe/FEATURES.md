...
2. Registration throws with a clear message if options are missing or an empty object (`Missing stripe configuration. Did you forget to pass it to the stripe plugin?`).
